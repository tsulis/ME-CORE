 ...
 * @author Mark Paluch
 */
public class PageImplWrapper<T> extends ChunkWrapper<T> implements PageWrapper<T> {
	...
	/**
	 * Creates a new {@link PageImplWrapper} with the given content. This will result in the created {@link Page} being identical
	...
	public <U> PageWrapper<U> map(Function<? super T, ? extends U> converter) {
		return new PageImplWrapper(getConvertedContent(converter), getPageable(), total);
	}
	...
	public boolean equals(@Nullable Object obj) {
		...
		if (!(obj instanceof PageImplWrapper<?>)) {
			return false;
		}

		PageImplWrapper<?> that = (PageImplWrapper<?>) obj;
