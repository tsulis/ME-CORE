 ...
 * @since 1.8
 */
abstract class ChunkWrapper<T> implements SliceWrapper<T>, Serializable {
  ...
  Pageable pageable;
	...
	/**
	 * Creates a new {@link ChunkWrapper} with the given content and the given governing {@link Pageable}.
	 *
	 * @param content must not be {@literal null}.
	 * @param pageable must not be {@literal null}.
	 */
	public ChunkWrapper(List<T> content, Pageable pageable) {
	...
	/**
	 * Applies the given {@link Function} to the content of the {@link ChunkWrapper}.
	 *
	...
	public boolean equals(@Nullable Object obj) {
		...
		ChunkWrapper<?> that = (ChunkWrapper<?>) obj;
